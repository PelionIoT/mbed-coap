...
/**
 * \fn int_t sn_coap_protocol_prepare_blockwise_stream(struct coap_s *handle,
...
/**
 * \fn int8_t sn_coap_protocol_store_blockwise_stream(struct coap_s *handle,
 *                                                     sn_coap_hdr_s *src_coap_msg_ptr,
 *                                                     const sn_coap_blockwise_context_s *blockwise_context,
 *                                                     void *param)
 *
 ...
 * \param *blockwise_context Pointer to sn_coap_blockwise_context_s struct containing the blockwise streaming
 *                           context
 * \param *param Pointer to user context.
 * \return returns 0 on success, -2 if allocation failed
 *
 * \brief If blockwising is enabled this function can be used to initiate a blockwise streaming request.
 */
