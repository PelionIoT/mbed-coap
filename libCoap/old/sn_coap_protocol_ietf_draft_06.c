/**************************************************************************//**
 * \file sn_coap_protocol_ietf_draft_06.c
 *
...
int8_t coap_protocol_destroy(void)
{
#if SN_COAP_RESENDING_MAX_MSGS_COUNT /* If Message resending is not used at all, this part of code will not be compiled */
...
/**************************************************************************//**
 * \fn SN_MEM_ATTR_COAP_PROTOCOL_FUNC int16_t sn_coap_build(sn_nsdl_addr_s *dst_addr_ptr, uint8_t *dst_packet_data_ptr, sn_coap_hdr_s *src_coap_msg_ptr)
 *
 ...
 *****************************************************************************/
SN_MEM_ATTR_COAP_PROTOCOL_FUNC
int16_t sn_coap_build(sn_nsdl_addr_s *dst_addr_ptr,
...
//        }
    ...
    byte_count_built = sn_coap_builder(dst_packet_data_ptr, src_coap_msg_ptr, (uint16_t)message_id);
...
/**************************************************************************//**
 * \fn SN_MEM_ATTR_COAP_PROTOCOL_FUNC sn_coap_hdr_s *sn_coap_parse(sn_nsdl_addr_s *src_addr_ptr, uint16_t packet_data_len, uint8_t *packet_data_ptr)
 *
 ...
 *****************************************************************************/
SN_MEM_ATTR_COAP_PROTOCOL_FUNC
sn_coap_hdr_s *sn_coap_parse(sn_nsdl_addr_s *src_addr_ptr, uint16_t packet_data_len, uint8_t *packet_data_ptr)
{
    ...
    returned_dst_coap_msg_ptr = sn_coap_parser(packet_data_len, packet_data_ptr, &coap_version, &msg_id);
    ...
    returned_dst_coap_msg_ptr->msg_id = msg_id;
...
/**************************************************************************//**
 * \fn SN_MEM_ATTR_COAP_PROTOCOL_FUNC sn_nsdl_transmit_s *sn_coap_exec(uint32_t current_time)
 *
 ...
 *****************************************************************************/
SN_MEM_ATTR_COAP_PROTOCOL_FUNC
sn_nsdl_transmit_s *sn_coap_exec(uint32_t current_time)
{
#if SN_COAP_RESENDING_MAX_MSGS_COUNT /* If Message resending is not used at all, this part of code will not be compiled */
    /* Get node count i.e. count of active resending messages */
                                                              ...
                                                              uint16_t msg_id)
{
    ...
    byte_count_built = sn_coap_builder(dst_packet_data_ptr, src_coap_msg_ptr, msg_id);
